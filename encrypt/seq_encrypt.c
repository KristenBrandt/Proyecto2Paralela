...
Titulo: Cifrado de un texto

Descripcion: El programa cifra el archivo 'input.txt' con la llave de 64 bits
que le pasamos en un archivo 'key.txt'.

Compilacion:
gcc seq_encrypt.c -o seq_encrypt -lstdc++

Correr:
./seq_decrypt

Para correr el programa es necesario tener en el mismo directorio un archivo
'input.txt' con el texto cifrado en bits y un archivo 'key.txt' con la llave de 64 bits.
